...
export default function About() {
    return (
        <div className='container'>
            ...
            <p className='aboutme'>
                I am a Full-Stack web developer having just earned my professional certificate from Georgia Tech through their Bootcamp Program. My background is in banking and financial management, and the analytical skills I was required to use in those fields made me want to get into web development. I am strongest in front-end development at this point, but feel like I am competent in all aspects. 
            </p>
            <p className='aboutme'>
